...
def test_check_in_with_flight_log(client, test_user, test_aircraft, test_instructor, app):
...
def test_check_out_with_flight_log(client, test_user, test_aircraft, test_instructor, app):
